    ...
    renderTemplate(value) {
        ...
        if (template !== undefined) {
            ...
            if (data.meta != undefined) {
                ...
                $("#mention").html("🎉 This template comes from " + data.meta.author + (data.meta.source !== undefined ? ", <a target=\"_blank\" rel=\"noopener noreferrer\" href='" + data.meta.source + "'>the original post can be found here.</a>" : "."));
            }
